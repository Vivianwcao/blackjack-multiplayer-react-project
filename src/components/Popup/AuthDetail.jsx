	...
	return (
		<div className="popup__content">
			...
			<div className="popup__partners-container">
				...
				<p className="typewriter">New! Try our mock accounts</p>
				<div>
					<button
						className="btn btn--mock"
						onClick={() => handleEmailSignIn("kyle@gmail.com", 123456)}
					>
						Kyle
					</button>
					<button
						className="btn btn--mock"
						onClick={() => handleEmailSignIn("marlo@gmail.com", 123456)}
					>
						Marlo
					</button>
					<button
						className="btn btn--mock"
						onClick={() => handleEmailSignIn("anya@gmail.com", 123456)}
					>
						Anya
					</button>
				</div>
